...
typedef struct line_error_info_ {
    ...
    float32 Last_m_f32LeftBorderKappa;

    float32 m_f32RightBorderAimingMin;
    float32 m_f32RightBorderAimingMax;
    float32 m_f32RightBorderKappa;
    float32 Last_m_f32RightBorderKappa;

    float32 m_f32RampError;
    uint8 m_u8RampErrorValid;

    float32 Leftpure_distance; // 预瞄中心到车中心
    float32 Rightpure_distance;

    float32 error_Leftangle;
    float32 error_Rightangle;
} LINE_ERROR_INFO;
